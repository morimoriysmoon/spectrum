                ...
                "<div class='sp-picker-container'>",
                    "<div class='sp-top sp-cf'>",
                        ...
                        "<div class='sp-top-inner'>",
                            ...
                            "</div>",
                            "<div class='sp-hue'>",
                                "<div class='sp-slider' title='Hue'></div>",
                                gradientFix,
                            "</div>",
                            "<div class='sp-white'>",
                                "<div class='sp-slider' title='White'></div>",
                            "</div>",
                            "<div class='sp-amber'>",
                                "<div class='sp-slider' title='Amber'></div>",
                            "</div>",
                            "<div class='sp-uv'>",
                                "<div class='sp-slider' title='UV'></div>",
                            "</div>",
                            "<div class='sp-colortemp'>",
                                "<div class='sp-slider' title='Color Temp.'></div>",
                            "</div>",
                            "<div class='sp-infrared'>",
                                "<div class='sp-slider' title='Infrared'></div>",
                            "</div>",
                        "</div>",
